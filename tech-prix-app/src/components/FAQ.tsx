      ...
      <div className="f1-container max-w-850" style={{ position: 'relative', padding: '0px 0 40px 0' }}>
        ...
        <div style={{ position: 'relative', zIndex: 10 }}>
          ...
          {[
            ...
            {q: 'Is there a registration fee?', a: 'Yes, the team entry fee is ₹200. This covers entry passes for all team members.'},
            {q: 'What if we want to add an additional team member?', a: 'Any additional member joining the team beyond the standard limit will cost an extra ₹50 per person.'},
